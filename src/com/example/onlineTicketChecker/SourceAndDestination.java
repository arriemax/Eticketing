...
public class SourceAndDestination extends AsyncTask<String, String, String> {

	JSONParser jParser = new JSONParser();
	// url to get all products list
	private static String url = "sourceanddestination.php";	// JSON Node names
	...
	JSONArray user = null;
	int i = 0;
	public SourceAndDestination(Context parent, String city) {
			...
			protected String doInBackground(String... args) {
				...
				params.add(new BasicNameValuePair("city",this.cityname));
                ...
                JSONObject cityobj =null;
                  for(int i=0;i<city.length();i++)
                  {
                	  ...
                	  cities.add(cityobj.getString("places"));
