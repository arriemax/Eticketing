...
public class LoginCheckAdmin extends AsyncTask<String, String, String> {

	JSONParser jParser = new JSONParser();
	// url to get all products list
	//private static String login_url = "http://10.0.2.2/android_connect/login_admin.php";	// JSON Node names
	private static String login_url = "login_admin.php";
	...
	Activity mActivity;
    Boolean error=false;
	public LoginCheckAdmin(Activity activity,Context parent, TextView username,TextView password) {
	            this.parent=parent;
			...
			protected void onPreExecute() {
				...
				pDialog.setMessage("Wait.. Signing ...");
			...
			protected String doInBackground(String... args) {
				...
				try {
					...
					if (success == 1) {
                        ...
                        {
                        session.AdminLogin();
						Intent i = new Intent(this.parent, AdminHome.class);
			...
			protected void onPostExecute(String file_url) {
				...
				if(error)
				{
					Toast.makeText(this.parent,"Invalid Login",Toast.LENGTH_SHORT).show();
				}
